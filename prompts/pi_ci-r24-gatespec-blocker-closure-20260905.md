...
- Runner-managed output path: `runs/pi_ci-r24-gatespec-blocker-closure-20260905.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/ci-r24-gatespec-blocker-closure-20260905_context.md`
...
Output schema:
1. `# Hermes Task Plan: ci-r24-gatespec-blocker-closure-20260905`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
