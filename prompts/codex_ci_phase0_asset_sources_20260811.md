...
- Runner-managed output path: `runs/codex_ci_phase0_asset_sources_20260811.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/ci_phase0_asset_sources_20260811_context.md`
...
Output schema:
1. `# Codex Direct Task: ci_phase0_asset_sources_20260811`
2. `## Boundary Check`
3. `## Direct Work`
