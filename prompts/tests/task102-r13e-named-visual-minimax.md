...
- Runner-managed output path: `runs/tests/r13e-named-visual/minimax.md`。不得用工具写入，由 runner 持久化最终回答。
...
- `runs/tests/r13e-named-visual/minimax.md`（runner 管理；只返回正文，不用工具写入）
