...
- Runner-managed report path: `runs/execution/ci_phase5_a_values_matrix_fix/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实现首页与安全性详情页共享的响应式矩阵布局和可读性测试，覆盖常见桌面及窄视野
...
Output schema:
1. `# Execution Output: ci_phase5_a_values_matrix_fix - worker_03`
