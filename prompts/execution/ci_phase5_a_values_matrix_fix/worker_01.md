...
- Task id: `ci_phase5_a_values_matrix_fix`
- Role id: `worker_01`
...
- Runner-managed report path: `runs/execution/ci_phase5_a_values_matrix_fix/worker_01.md`. Never invoke write/edit tools
...
Objective:
修正A类正式报告数值覆盖、受控术语归一和首页/安全性详情矩阵的默认视野适配，并以真实浏览器验收

Task:
Execute only this assigned work item: 审计来源、抽取、归一、投影和默认可见五层数值覆盖，定位疗效与安全性缺数的最早发生层并提出最小修正
...
Output schema:
1. `# Execution Output: ci_phase5_a_values_matrix_fix - worker_01`
