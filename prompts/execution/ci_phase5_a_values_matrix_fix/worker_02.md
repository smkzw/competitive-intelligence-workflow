...
- Runner-managed report path: `runs/execution/ci_phase5_a_values_matrix_fix/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实现安全事件受控同义归一、默认列选择和图表表格同源筛选，保留原始术语及真实未公开状态
...
Output schema:
1. `# Execution Output: ci_phase5_a_values_matrix_fix - worker_02`
