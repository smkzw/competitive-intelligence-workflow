...
- Runner-managed report path: `runs/execution/ci-phase6-task610/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实现并验证 fixtures/positive/b-pnh 与三个 D70 独立输入包、catalog 摘要及 RED/GREEN 案例合同。
...
Output schema:
1. `# Execution Output: ci-phase6-task610 - worker_01`
