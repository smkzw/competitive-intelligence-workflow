...
- Runner-managed report path: `runs/execution/ci-phase6-task610/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 运行 Phase 6 精确确定性测试与 A 类回归，深挖任何零竞品、零试验、字段缺失或状态异常并形成紧凑交接。
...
Output schema:
1. `# Execution Output: ci-phase6-task610 - worker_03`
