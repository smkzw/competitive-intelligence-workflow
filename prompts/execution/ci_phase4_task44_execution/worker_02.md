...
- Runner-managed report path: `runs/execution/ci_phase4_task44_execution/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实现类型化 ChartSpec 注册、可比性分组与稳定小多图拆分，只消费锁定快照规范行
...
Output schema:
1. `# Execution Output: ci_phase4_task44_execution - worker_02`
