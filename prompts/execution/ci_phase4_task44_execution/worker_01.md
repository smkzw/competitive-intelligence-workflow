...
- Runner-managed report path: `runs/execution/ci_phase4_task44_execution/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 以 RED 反例冻结九类图形输入、未知类型拒绝、缺失非零和所有行恰好一次的兼容性合同
...
Output schema:
1. `# Execution Output: ci_phase4_task44_execution - worker_01`
