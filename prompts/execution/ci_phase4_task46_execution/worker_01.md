...
- Runner-managed report path: `runs/execution/ci_phase4_task46_execution/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 先写站点地图集合一一对应失败测试，再实现静态责任页与每个产品/试验动态详情页枚举合同
...
Output schema:
1. `# Execution Output: ci_phase4_task46_execution - worker_01`
