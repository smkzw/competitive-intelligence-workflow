...
- Task id: `ci_phase4_task46_execution`
- Role id: `worker_03`
...
- Runner-managed report path: `runs/execution/ci_phase4_task46_execution/worker_03.md`. Never invoke write/edit tools
...
Objective:
实现 Task 4.6 全站浏览器验收工具及其确定性测试

Task:
Execute only this assigned work item: 先写 Chromium/WebKit 1280/1440/1920 运行时失败测试，再实现 CLI、原分辨率截图和交互 trace 输出
...
Output schema:
1. `# Execution Output: ci_phase4_task46_execution - worker_03`
