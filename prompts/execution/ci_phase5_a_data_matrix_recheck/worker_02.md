...
- Runner-managed report path: `runs/execution/ci_phase5_a_data_matrix_recheck/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 负责安全性热图显示链路：在1024/1280默认桌面视口复现首页与安全性详情页横向拖动，修复共享JS/CSS和浏览器回归测试；不得修改研究数据或数值。
...
Output schema:
1. `# Execution Output: ci_phase5_a_data_matrix_recheck - worker_02`
