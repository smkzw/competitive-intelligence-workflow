...
- Runner-managed output path: `runs/zcode_ci-phase10-task106-rc-freeze.md`. Never invoke a write/edit tool on this report path; return the complete report and let the runner persist it.

Read these files only:
- `context/{task_id}_context.md`
...
Output schema:
1. `# Z Code Task: ci-phase10-task106-rc-freeze`
2. `## Boundary Check`
3. `## Work Performed`
