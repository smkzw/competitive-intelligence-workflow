...
- Runner-managed report path: `runs/conference/ci-rebaseline-r1-contract-review-20260904/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/ci-rebaseline-r1-contract-review-20260904_conference_context.md`
- `plans/codex_main_venue_ci-rebaseline-r1-contract-review-20260904.md`
...
Objective:
独立审查当前 v1.3 正式设计、路线图、执行计划 v3、ZCode 处置和 Task 10.6 三文档是否完整、互相一致并忠实实现 2026-09-04 已锁定产品裁决；只返回证据化 PASS/VETO 与具体缺口，不修改文件，不重新裁决用户已定事项。
...
Output schema:
1. `# Conference Participant Output: ci-rebaseline-r1-contract-review-20260904 - general_single_object`
2. `## Boundary Check`
