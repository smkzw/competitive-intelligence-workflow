...
- Runner-managed report path: `runs/conference/ci_phase6_task61_independent_review/general_pi_antigravity.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Objective:
独立挑战并验收 Task 6.1 研究角色、论文角色分列及终点时间窗兼容合同；重点核查错误纳入、model_copy 篡改、规则歧义、原始语义与版本谱系，禁止只复述测试通过。
...
Output schema:
1. `# Conference Participant Output: ci_phase6_task61_independent_review - general_pi_antigravity`
2. `## Boundary Check`
