...
- Runner-managed report path: `runs/conference/ci_phase6_task61_independent_review/general_grok46.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: ci_phase6_task61_independent_review - general_grok46`
2. `## Boundary Check`
