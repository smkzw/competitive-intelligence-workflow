...
- Do not write the runner-managed report path `runs/conference/ci-phase10-task104-migration-manifest/general_single_object.md`; return the complete report for the runner.

Initial read set:
- `context/ci-phase10-task104-migration-manifest_conference_context.md`
- `plans/codex_main_venue_ci-phase10-task104-migration-manifest.md`

Objective:
同号正式复核 Task 10.4 迁移清单最终状态与治理关联：确认 59 项测试、精确白名单/排除、敏感哨兵、D01-D70 非运行归档、P0/P1/P2=0，以及不越界到 Task 10.5/10.8；只读。
...
Output schema:
1. `# Conference Participant Output: ci-phase10-task104-migration-manifest - general_single_object`
2. `## Boundary Check`
