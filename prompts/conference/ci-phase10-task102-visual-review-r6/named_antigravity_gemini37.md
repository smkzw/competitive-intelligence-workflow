...
- Runner-managed report path: `runs/conference/ci-phase10-task102-visual-review-r6/named_antigravity_gemini37.md`. Return the report inline; never write it with tools.
...
- `runs/conference/ci-phase10-task102-visual-review-r6/named_antigravity_gemini37.md`（runner 管理）
