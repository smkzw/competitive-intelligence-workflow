...
- Runner-managed report path: `runs/conference/ci_phase3_task33_acceptance/general_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/ci_phase3_task33_acceptance_conference_context.md`
- `plans/codex_main_venue_ci_phase3_task33_acceptance.md`
...
Objective:
独立验收 Task 3.3 用户辅助下载、自动识别归档与幂等恢复实现，审查真实用户路径、规则绑定、状态事件和假绿

Task:
Perform a read-only adversarial acceptance audit of Task 3.3. Read the source packet named in the conference context and do not read the other participant output. Run the exact three-file pytest command, then create minimal temporary-directory probes for the challenge list in the context. Inspect actual events, request/job ledgers, the Chinese download list, inbox/quarantine/library files and the SQLite source version. Do not accept test counts as proof. Find false claims, unexecuted branches, source/schema disagreement, lost ledger rows, repeated effects, or user actions beyond “download, keep the original filename, place it in one folder”. Report P0/P1/P2 with reproduction and recommend PASS only when P0=0 and P1=0.
...
Output schema:
1. `# Conference Participant Output: ci_phase3_task33_acceptance - general_pi_qwen38`
2. `## Boundary Check`
3. `## Independent Work Product`
4. `## Evidence And Assumptions`
5. `## Risks, Gaps, And Verification Needs`
6. `## Recommended Next Step`
7. `## Verdict` ending exactly `PASS|FAIL; P0=n; P1=n; P2=n`
