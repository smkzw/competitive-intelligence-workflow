...
- Runner-managed report path: `runs/conference/ci_phase4_task44_visual/visual_pi_k3_256k.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/ci_phase4_task44_visual_conference_context.md`
- `plans/codex_main_venue_ci_phase4_task44_visual.md`
...
Objective:
以真实医学经理角色独立试用 Task 4.4 九类图表、完整表与筛选联动
...
Output schema:
1. `# Conference Participant Output: ci_phase4_task44_visual - visual_pi_k3_256k`
2. `## Boundary Check`
