...
- Runner-managed report path: `runs/conference/ci_phase5_a_result_scientific_review/general_grok46.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: ci_phase5_a_result_scientific_review - general_grok46`
2. `## Boundary Check`
