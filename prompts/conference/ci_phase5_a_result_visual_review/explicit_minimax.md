...
# MODE=CONFERENCE｜用户指定视觉验收：Pi / Minimax M3
...
- Do not write or modify any file. Runner-managed output file: `runs/conference/ci_phase5_a_result_visual_review/explicit_minimax.md`; return the complete report in the final response and let the runner persist it.
