...
- Do not write the runner-managed report path `runs/conference/ci-phase10-task104-migration-manifest-review/general_single_object.md`; return the complete report for the runner.

Initial read set:
- `context/ci-phase10-task104-migration-manifest-review_conference_context.md`
- `plans/codex_main_venue_ci-phase10-task104-migration-manifest-review.md`

Objective:
独立审查 Task 10.4 最终迁移清单闭环：验证 10 项白名单、11 类排除、敏感哨兵、目标摘要、D01-D70 非运行归档与 Task 10.5/10.8 边界；只读，P0/P1 为零才可建议接受。
...
Output schema:
1. `# Conference Participant Output: ci-phase10-task104-migration-manifest-review - general_single_object`
2. `## Boundary Check`
