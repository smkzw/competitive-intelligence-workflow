...
- Runner-managed report path: `runs/conference/ci_phase5_task52_verify/general_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/ci_phase5_task52_verify_conference_context.md`
- `plans/codex_main_venue_ci_phase5_task52_verify.md`
...
Objective:
独立攻击Task 5.2八类A视图的快照归属、版本血统、关系闭合和中文用户语义假绿
...
Output schema:
1. `# Conference Participant Output: ci_phase5_task52_verify - general_pi_qwen38`
2. `## Boundary Check`
