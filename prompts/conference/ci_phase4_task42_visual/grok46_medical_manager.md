...
Write exactly one output file: `runs/conference/ci_phase4_task42_visual/grok46_medical_manager.md`. It is runner-owned: return the review and do not write it with tools.
