...
- Runner-managed report path: `runs/conference/ci-phase8-task83-named-visual-testers/visual_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/ci-phase8-task83-named-visual-testers_conference_context.md`
- `plans/codex_main_venue_ci-phase8-task83-named-visual-testers.md`
...
Objective:
由三名用户点名的独立真实医学经理逐页审阅 Task 8.3 三份锁定 PDF 的 54 张当前页图及标准阅读器可读性证据，识别裁切、重叠、黑块、乱码、不可读图表、页眉页脚、页码、续表表头和中文原生表达问题；只读，不修改锁定 PDF。
...
Output schema:
1. `# Conference Participant Output: ci-phase8-task83-named-visual-testers - visual_single_object`
2. `## Boundary Check`
