...
- Runner-managed report path: `runs/conference/ci-phase6-task610-visual-review/visual_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/ci-phase6-task610-visual-review_conference_context.md`
- `plans/codex_main_venue_ci-phase6-task610-visual-review.md`
...
Objective:
以真实中国临床试验医学经理视角对 B 类 PNH 最终候选进行视觉、交互、中文原生性、数值完整性和默认视野独立终验
...
Output schema:
1. `# Conference Participant Output: ci-phase6-task610-visual-review - visual_single_object`
2. `## Boundary Check`
