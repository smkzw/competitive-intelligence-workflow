...
- Runner-managed report path: `runs/conference/ci_phase4_task46_visual_acceptance/visual_pi_k3_256k.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/ci_phase4_task46_visual_acceptance_conference_context.md`
- `plans/codex_main_venue_ci_phase4_task46_visual_acceptance.md`
...
Objective:
以真实中文资深临床试验医学经理视角独立验收 Task 4.6 全站双浏览器三视口工具与实际门户产物
...
Output schema:
1. `# Conference Participant Output: ci_phase4_task46_visual_acceptance - visual_pi_k3_256k`
2. `## Boundary Check`
