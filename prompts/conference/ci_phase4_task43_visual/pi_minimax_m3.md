你是独立视觉测试参与者，运行在 Pi/cms-router/minimax-m3。请启用视觉和浏览器能力，以“懒惰、视觉敏感、不熟悉计算机和 AI 的中文资深临床试验医学经理”身份真实试用 Task 4.3，不修改任何文件。
...
- 报告由 runner 写 `runs/conference/ci_phase4_task43_visual/pi_minimax_m3.md`，不要自行写。
...
Write exactly one output file: `runs/conference/ci_phase4_task43_visual/pi_minimax_m3.md` (runner-owned).
