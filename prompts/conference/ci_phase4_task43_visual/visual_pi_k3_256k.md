...
- Runner-managed report path: `runs/conference/ci_phase4_task43_visual/visual_pi_k3_256k.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/ci_phase4_task43_visual_conference_context.md`
- `plans/codex_main_venue_ci_phase4_task43_visual.md`
...
Objective:
以真实资深医学经理视角独立试用并审评 Task 4.3 筛选交互与视觉可用性
...
Output schema:
1. `# Conference Participant Output: ci_phase4_task43_visual - visual_pi_k3_256k`
2. `## Boundary Check`
