...
- Runner-managed output path: `runs/conference/ci_phase6_task69_visual_review/medical_manager_cursor_grok.md`. Return the full report in your final response; do not write this file with tools.
