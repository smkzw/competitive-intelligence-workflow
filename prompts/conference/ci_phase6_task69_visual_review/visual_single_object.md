...
- Runner-managed report path: `runs/conference/ci_phase6_task69_visual_review/visual_single_object.md`. Never invoke write/edit tools
...
- `plans/codex_main_venue_ci_phase6_task69_visual_review.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
以真实医学经理视角对 B 类多页面门户完成视觉、交互、中文原生性和信息密度终验，发现缺陷则进入修订复核循环
...
Output schema:
1. `# Conference Participant Output: ci_phase6_task69_visual_review - visual_single_object`
2. `## Boundary Check`
