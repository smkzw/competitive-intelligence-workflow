...
- Runner-managed report path: `runs/conference/ci-phase7-task75-visual-review/visual_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/ci-phase7-task75-visual-review_conference_context.md`
- `plans/codex_main_venue_ci-phase7-task75-visual-review.md`
...
Objective:
以资深临床试验医学经理视角，对C类特应性皮炎十二页设计门户和逐试验详情进行独立视觉、中文表达、信息完整性与交互一致性验收；候选摘要必须匹配冻结版本
...
Output schema:
1. `# Conference Participant Output: ci-phase7-task75-visual-review - visual_single_object`
2. `## Boundary Check`
