...
- Runner-managed report path: `runs/conference/ci-phase10-task102-visual-review/visual_single_object.md`. Never invoke write/edit tools
...
Objective:
以真实医学经理视角独立审阅 Task 10.2 三个站点式 HTML：信息架构、默认首屏、图先表后、安全性矩阵无需横向拖动、中文原生性、图表/卡片/间距/配色/交互一致性与全路由可读性；只报告缺陷与接受/否决，不修改产物。
...
Output schema:
1. `# Conference Participant Output: ci-phase10-task102-visual-review - visual_single_object`
2. `## Boundary Check`
