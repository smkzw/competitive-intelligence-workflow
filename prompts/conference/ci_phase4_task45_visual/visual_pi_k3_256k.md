...
- Runner-managed report path: `runs/conference/ci_phase4_task45_visual/visual_pi_k3_256k.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/ci_phase4_task45_visual_conference_context.md`
- `plans/codex_main_venue_ci_phase4_task45_visual.md`
...
Objective:
以真实资深医学经理角色独立试用 Task 4.5 数据依据面板、固定对照和交互闭环
...
Output schema:
1. `# Conference Participant Output: ci_phase4_task45_visual - visual_pi_k3_256k`
2. `## Boundary Check`
