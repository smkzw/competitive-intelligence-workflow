...
- Runner-managed report path: `runs/conference/ci_phase0_contract_review_20260810/general_grok45.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: ci_phase0_contract_review_20260810 - general_grok45`
2. `## Boundary Check`
