...
- Runner-managed report path: `runs/conference/ci-phase7-task75-named-visual-testers/visual_single_object.md`. Never invoke write/edit tools
  to create or update this report file; return the complete report in your
  final assistant response and let the bounded runner persist it. Do not create
  sibling output files.

Initial read set:
- `context/ci-phase7-task75-named-visual-testers_conference_context.md`
- `plans/codex_main_venue_ci-phase7-task75-named-visual-testers.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
按用户点名的 Minimax-M3 与 CodeBuddy hy3-x 补充独立真实医学经理视觉审阅；不得替代正式 Cursor Grok 视觉会商或 Codex 最终验收
...
Output schema:
1. `# Conference Participant Output: ci-phase7-task75-named-visual-testers - visual_single_object`
2. `## Boundary Check`
