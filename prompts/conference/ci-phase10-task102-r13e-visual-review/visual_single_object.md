...
- Runner-managed report path: `runs/conference/ci-phase10-task102-r13e-visual-review/visual_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/ci-phase10-task102-r13e-visual-review_conference_context.md`
- `plans/codex_main_venue_ci-phase10-task102-r13e-visual-review.md`
...
Objective:
由用户点名的三名独立真实医学经理基于 ego(lite) 逐项审阅 R13e A/B/C 站点式 HTML 的交互、横向比较、方案设计矩阵、默认视野与中文视觉体验；只读，不改代码。
...
Output schema:
1. `# Conference Participant Output: ci-phase10-task102-r13e-visual-review - visual_single_object`
2. `## Boundary Check`
