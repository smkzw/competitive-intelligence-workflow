# Conference Context: ci_phase4_task41_review

Created: 2026-08-13 23:33:57
Objective: 独立攻击 Task 4.1 报告视图、覆盖集、页面注册与图表表格同源合同，P0/P1 清零后方可接受
...
- Task 4.1 当前源码、Schema、冻结 A/B/C 页面目录与对应测试。

## Scope

- In scope：稳定 ReportViewModel/row identity、coverage set/projection、冻结页面责任、图表表格同源合同与安装包可用性。
- Out of scope：门户 HTML/视觉、A/B/C 完整业务页、PDF/PPT、外部检索、安全测试。
...
- P0/P1 必须清零；任何可绕过冻结页面责任、行集同源或覆盖投影身份的路径均不得接受。
...
- 2026-08-13 23:33:57: Conference initialized by `hermes_workflow_guard.py init-conference`.
