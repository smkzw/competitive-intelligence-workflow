# 独立科学复核任务（报告 B · 项目 abc-v100 · PNH 竞品调研工作流 · 第 58 轮）
...
## 必读材料
1. `runs/pnh-vertical/abc-v100/state/scientific_review/B/review_request.json` — 复核请求（含全部绑定字段）
2. `runs/pnh-vertical/abc-v100/reports/B/v1/html/` — 已渲染门户
...
## 产出（必须）
写文件 `runs/pnh-vertical/abc-v100/state/scientific_review/B/verdict.json`，UTF-8 JSON：
- `schema_version`: "1.0"
...
- `verdict_id`: "verdict-omp-deepseek-abc100-b-r58"
...
- `candidate_snapshot_id`: `report-snapshot_69f4d40efb2ec3ea6a135ea5`
- `candidate_content_digest`: `437ce4aa53b2bbb882e0897cc982e14dbce9633263e7706f3c5e20082fd45a3a`
- `gate_result_key`: `gate-result_0739896d1958448707c1370a`
- `coverage_set_id`: `coverage-set_adec20e1d302ea88fe78ab96`
- `coverage_digest`: `611e9ffd883805439957b045f39bce1c71ca48b3f54f21b481145c6ce2b40a72`
