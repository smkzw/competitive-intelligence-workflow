# 独立科学复核任务（报告 C · 项目 abc-v101 · PNH · 第 43 轮）

你是独立上下文复核者，与生产者无共享会话。基于自己对仓库文件的真实检查给出结论。

## 材料
1. `runs/pnh-vertical/abc-v101/state/scientific_review/C/review_request.json`（绑定字段）
2. `runs/pnh-vertical/abc-v101/reports/C/v1/html/`（已渲染门户）
...
## 产出
写 `runs/pnh-vertical/abc-v101/state/scientific_review/C/verdict.json`（UTF-8 JSON）：
...
- verdict_id: "verdict-omp-deepseek-abc101-c-r43"；verdict: "accepted"|"veto"
...
- `candidate_snapshot_id`: `report-snapshot_c091aae58d0f5bbb82af2a6b`
- `candidate_content_digest`: `6d10b4d398694dcc810f79681d71da28557b8df80647ed36e655e23cdb260312`
- `gate_result_key`: `gate-result_b2c82926a501fd199d4d9e96`
- `coverage_set_id`: `coverage-set_9cf454aacd99a115ea168c2d`
- `coverage_digest`: `ff6911dde40549aa373d89651de8027eac19e5c43661e6b65f8af4fa112cdea9`
