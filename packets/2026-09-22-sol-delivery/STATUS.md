...
- 受影响来源整族 `30 passed in 55.29s`，改动源 Ruff/strict-mypy 通过。这只证明原子层；尚未将它们批量形成稳定 `ResearchFact`、摄取入正式快照并绑定 A/B/C 门户，也没有重算 4412 条展示事实的闭包分子。W07 科学来源门仍 FAIL；24 门户与 RC 仍未验收。下一步按 W07 工作包先贯通真实小批入库和页面，再扩全量，不继续旧 PNH v107 补丁循环。
