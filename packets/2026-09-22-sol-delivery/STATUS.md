...
| 05 产品—研究—组别 | W02/W07 | arm–intervention 多对多 `product_links`；AE 事件组按声明组别关联；真实 PNH 多产品试验进各产品页。疗效 2411、安全 414、其他观察 247 行无唯一产品归属，A 图表暂不绘制前两类，完整表标“待核/未绘图”，搜索标题不冒充主产品。载荷仍有兼容性单产品 fallback | 建立原生复合臂/子群与产品关联身份，复核 B/C 下游；不能把暂时安全隔离当归属闭包 |
