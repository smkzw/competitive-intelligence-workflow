...
GT03_FORMAT_FIXTURE: tuple[LiteralEdge, ...] = (
    ...
    LiteralEdge(
        ...
        to_state="generating",
        trigger="beautification_round_requested",
...
_GT03_RENDER_EVIDENCE = _evidence()
_GT03_RENDER_DIGEST = visual_contract_digest(_GT03_RENDER_EVIDENCE)
_GT03_VISUAL_VERDICT = _verdict()
_GT03_VISUAL_VERDICT["render_evidence_digest"] = _GT03_RENDER_DIGEST
_GT03_VERDICT_DIGEST = visual_contract_digest(_GT03_VISUAL_VERDICT)
...
GT03_VALID_EVIDENCE: dict[str, dict[str, object]] = {
    ...
    "g_format_quality_check_generating": {
        ...
        "render_evidence_digest": _GT03_RENDER_DIGEST,
    ...
    "g_format_quality_check_passed": {
        ...
        "visual_verdict_digest": _GT03_VERDICT_DIGEST,
        "visual_verdict_artifact_digest": "b" * 64,
        "visual_verdict_render_digest": _GT03_RENDER_DIGEST,
        "visual_verdict_plan_digest": "a" * 64,
        "visual_verdict_format": "html",
        "producer_identity": _GT03_VISUAL_VERDICT["producer_identity"],
        "verifier_identity": _GT03_VISUAL_VERDICT["verifier_identity"],
        "open_blocking_visual_defects": 0,
        "render_evidence": _GT03_RENDER_EVIDENCE,
        "visual_verdict": _GT03_VISUAL_VERDICT,
    },
    "g_format_passed_delivery_ready": {
        ...
        "artifact_id": "artifact-1",
        "candidate_artifact_digest": "b" * 64,
        "visual_verdict_id": _GT03_VISUAL_VERDICT["verdict_id"],
        "visual_verdict_digest": _GT03_VERDICT_DIGEST,
        "visual_verdict_artifact_digest": "b" * 64,
        "snapshot_id": "snapshot-1",
        "format": "html",
        ...
        "candidate_visual_plan_digest": "a" * 64,
        "candidate_format": "html",
        "render_evidence_id": _GT03_RENDER_EVIDENCE["evidence_id"],
        "render_evidence_digest": _GT03_RENDER_DIGEST,
        "rendered_artifact_digest": "b" * 64,
        "rendered_format": "html",
        "visual_verdict_render_digest": _GT03_RENDER_DIGEST,
    ...
    "g_format_quality_check_blocked": {
        "format_recovery_exhausted": True,
        "failure_evidence_saved": True,
        "beautification_round_limit_reached": True,
    },
